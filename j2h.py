...
from tensorflow.keras.callbacks import EarlyStopping, ReduceLROnPlateau
cp = ModelCheckpoint('C:/LPD_competition/lotte_projcet0322.h5',monitor='val_acc',save_best_only=True, verbose=1)
...
# predict
model.load_weights('C:/LPD_competition/lotte_projcet0322.h5')
...
sub.to_csv('C:/LPD_competition/answer0322.csv',index=False)
