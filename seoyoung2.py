...
dropout = 0.4
epochs = 1000
model_path = 'C:/LPD_competition/lpd_{0:03}.hdf5'.format(filenum)
save_folder = 'C:/LPD_competition/submit_{0:03}'.format(filenum)
...
for tta in range(50):
    ...
    sub.to_csv(save_folder + 'C:/LPD_competition/sample_{0:03}_{1:02}.csv'.format(filenum, (tta+1)), index = False)